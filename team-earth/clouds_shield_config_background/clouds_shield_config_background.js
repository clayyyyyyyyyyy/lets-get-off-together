...
const frag = `
  ...
  // Soft radial star without hard linear bloom artifacts
  ...
  vec3 enhancedStarField(vec2 uv, float clearSky, float skyHeightMask) {
    ...
    // Subtle clustered depth inspired by volumetric star fields
    ...
    // Rare brighter stars, kept restrained
    ...
    // Fixed bright stars for structure, smaller and softer
  ...
  void main() {
    ...
    // Stars behind clouds, but still visible through thinner openings
    ...
    // subtle moonlit-blue lift on thinner cloud edges
